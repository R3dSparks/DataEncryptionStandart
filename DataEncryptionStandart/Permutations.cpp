...
int* Permutations::Permutate(const int* _value, const perm_64 _permutationTable)
{
	int* perm_value = new int[64];

	for (int i = 0; i < 64; i++)
		perm_value[_permutationTable[i]] = _value[i];
